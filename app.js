...
var incompleteTaskHolder=document.querySelector(".todo-list__incomplete-tasks");//ul of #incomplete-tasks
...
var createNewTaskElement=function(taskString){
  ...
  checkBox.className = "todo-list__input-checkbox";

  label.className="todo-list__task-text";
  
  editInput.type="text";
  editInput.className="todo-list__input-text";
...
var bindTaskEvents=function(taskListItem,checkBoxEventHandler){
  ...
  var checkBox=taskListItem.querySelector(".todo-list__input-checkbox");
  var editButton=taskListItem.querySelector(".todo-list__button_edit");
  var deleteButton=taskListItem.querySelector(".todo-list__button_delete");
